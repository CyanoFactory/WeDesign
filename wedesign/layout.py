...
class Panel(Fieldset):
    ...
    """
    template = "wedesign/layout/panel.html"
...
class Modal(Fieldset):
    ...
    Layout object. It wraps fields in a <div class="panel panel-default">
    """
    template = "wedesign/layout/modal.html"
...
class ModalHeader(Fieldset):
    ...
    """
    template = "wedesign/layout/modal_header.html"
...
class CancelButton(Button):
    ...
    """
    template = "wedesign/layout/cancel_button.html"